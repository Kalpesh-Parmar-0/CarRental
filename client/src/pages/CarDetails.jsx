        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              ...
              {car.owner && (
                <div
                  className="flex items-center gap-3 mt-4 p-3 bg-light rounded-lg cursor-pointer hover:bg-gray-200 transition-all"
                  onClick={() => navigate(`/cars?owner=${car.owner._id}`)}
                >
                  <div>
        ...
        <div>
          ...
          >
            ...
            <p className="text-center text-sm">
              No credit card require to reserve
            </p>
          </motion.form>
        </div>
      </div>
