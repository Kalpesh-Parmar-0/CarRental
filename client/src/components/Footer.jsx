        ...
        className='flex flex-wrap justify-between items-start gap-8 pb-6 border-b border-borderColor'>
            <div>
                ...
                className='max-w-80 mt-3'>
                    Premium car rental service with a wide selection of luxury and every day vehicles for all your driving needs.
                </motion.p>
                <motion.div
                initial = {{opacity: 0}}
                whileInView={{opacity: 1}}
            ...
            className='flex flex-wrap justify-between w-1/2 gap-8 '>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li>123 Luxury Car Drive</li>
                        <li>Ahemdabad Gujarat</li>
                        <li>+91 1234567890</li>
                        <li>carrental123.@gmail.com</li>
                    </ul>
                </div>
            </motion.div>            
        </motion.div>
